...
client.on('message', msg => {
    ...
    if (msg.content.startsWith(prefix + 'work')) {
        ...
        setTimeout(function(){ 
            mongoCurrency.giveCoins(msg.author.id, msg.guild.id, 100);
        }, 120000);
    }
    ...
    if (msg.content.startsWith(prefix + 'gamble')) {
        ...
        setTimeout(function(){ 
            mongoCurrency.deductCoins(msg.author.id, msg.guild.id, messagesplit[1]);
            ...
            if (bot_roll > player_roll) {
                ...
                mongoCurrency.giveCoins(msg.author.id, msg.guild.id, messagesplit[1] * 2);
            }
            ...
            if (bot_roll == player_roll) {
                ...
                mongoCurrency.giveCoins(msg.author.id, msg.guild.id, messagesplit[1]);
            }
        }, 5);
